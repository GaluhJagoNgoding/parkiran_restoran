...
<head>
    ...
    <title>Tambah Tarif - Sistem Parkir</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form method="POST" action="index.php?url=tarif/store">
                <?php echo Csrf::field(); ?>
                <div class="form-group">
                    <label for="jenis_kendaraan">Jenis Kendaraan <span style="color:red;">*</span></label>
                    <input type="text" id="jenis_kendaraan" name="jenis_kendaraan" placeholder="Contoh: Motor, Mobil" required>
                </div>

                <div class="form-group">
                    <label for="tarif_per_jam">Tarif Per Jam (Rp) <span style="color:red;">*</span></label>
                    <input type="number" id="tarif_per_jam" name="tarif_per_jam" placeholder="Contoh: 5000" min="1" required>
                </div>

                <div class="form-group">
                    <label for="tarif_per_hari">Tarif Per Hari (Rp) <span style="color:red;">*</span></label>
                    <input type="number" id="tarif_per_hari" name="tarif_per_hari" placeholder="Contoh: 50000" min="1" required>
                </div>

                <div class="form-buttons">
                    <button type="submit" class="btn-submit">Simpan Tarif</button>
