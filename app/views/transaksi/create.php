...
<head>
    ...
    <title>Tambah Transaksi - Sistem Parkir</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="form-container">
            ...
            <?php } ?>
            <h2>➕ Tambah Transaksi Parkir</h2>

            <form method="POST" action="index.php?url=transaksi/store">
                <?php echo Csrf::field(); ?>
                <div class="form-group">
                    <label for="id_kendaraan">Pilih Kendaraan <span style="color:red;">*</span></label>
                    <select id="id_kendaraan" name="id_kendaraan" required>
                        <option value="">-- Pilih Kendaraan --</option>
                        <?php if (isset($kendaraan) && $kendaraan && mysqli_num_rows($kendaraan) > 0): ?>
                ...
                <div class="form-group">
                    <label for="id_area">Pilih Area <span style="color:red;">*</span></label>
                    <select id="id_area" name="id_area" required>
                        <option value="">-- Pilih Area --</option>
                        <?php if (isset($areas) && $areas && mysqli_num_rows($areas) > 0): ?>
