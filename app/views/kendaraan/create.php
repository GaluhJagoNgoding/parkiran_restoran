...
<body>
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form method="POST" action="index.php?url=kendaraan/store">
                <?php echo Csrf::field(); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="jenis_kendaraan" name="jenis_kendaraan" placeholder="Contoh: Motor, Mobil, Truk" required>
                </div>

                <div class="form-group">
                    <label for="warna">Warna</label>
                    <input type="text" id="warna" name="warna" placeholder="Contoh: Merah, Hitam">
                </div>

                <div class="form-group">
                    <label for="pemilik">Pemilik</label>
                    <input type="text" id="pemilik" name="pemilik" placeholder="Nama pemilik kendaraan">
                </div>
